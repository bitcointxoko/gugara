...
function setupI18n({ withLocale: _locale } = { withLocale: "en" }) {
	dictionary.set({
		en: {
			...
			relays: {
				title: "Relays",
				tooltip: "Did you know that much of this website lives on nostr? A relay is where data is stored in the nostr protocol",
			},
			convert: {
				title: "Convert",
				price: "Price",
		...
		es: {
			...
			signin: {
				...
				extension: "Extensión",
				extensionHelp:
					"Utilizar una extensión nostr para iniciar sesión.",
				nostrConnect: "Nostr Connect",
				nostrConnectHelp:
				...
				signup: "Registrarse",
				signupHelp:
					"Apuntarse con correo electrónico en Flockstr",
				flockstr: "Flockstr",
			},
			meetup: {
			...
			mint: {
				...
				balance: "🥜 Saldo",
				nutstash: "Nutstash",
				tooltip: "Un mint es como un banco para ecash, que ofrece transacciones instantáneas y privadas",
			},
			nodes: {
				channels: "Canales: ",
				capacity: "Capacidad: ",
			...
			relays: {
				title: "Relays",
				tooltip: "Sabías que gran parte de este sitio web vive en nostr? Un relay es donde se almacenan los datos en el protocolo nostr",
			},
			convert: {
				title: "Conversor",
				price: "Precio",
		...
		eu: {
			...
			mint: {
				...
				balance: "🥜 Saldo",
				nutstash: "Nutstash",
				tooltip: "Mint bat ihes egiteko banku bat bezalakoa da, berehalako tranakzioak eta transakzio pribatuak eskaintzen dituena",
			},
			nodes: {
				channels: "Kanalak: ",
				capacity: "Edukiera: ",
			...
			relays: {
				title: "Relays",
				tooltip: "Ba al zenekien webgune honen zati handi bat nostr hizkuntzan bizi dela? Relay batean gordetzen dira datuak nostr protokoloan",
			},
			onboardingBitcoin: {
				title: "Empezar con Bitcoin",
				description:
		...
		zh: {
			...
			relays: {
				title: "中繼器",
				tooltip: "你知道本網站的大部分內容都保存在 nostr 上嗎？中繼器是在 nostr 協議裏儲存數據的地方",
			},
			footer: {
				simplex: "SimpleX",
				github: "GitHub",
