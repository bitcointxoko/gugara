...
<div
  class="mt-6 h-30 rounded-lg border border-solid hover:border-amber-500 bg-white text-black font-mono max-w-lg max-h-58"
>
  ...
  <div class="grid grid-cols-2 align-bottom">
    <a href="{PUBLIC_LIGHTNING_EXPLORER}{PUBLIC_NODE_PUBKEY_1}">
      ...
      {:else}
        <h3
          class="p-10 font-bold text-emerald-500 bg-amber-400 hover:bg-amber-600 hover:text-emerald-300 hover:drop-shadow-lg shadow rounded-l-lg align-bottom"
        >
          {$_("loading")}
        </h3>
      {/if}
    ...
    <a href="{PUBLIC_LIGHTNING_EXPLORER}{PUBLIC_NODE_PUBKEY_2}">
      {#if node2}
        <div
          class="p-10 text-amber-300 bg-emerald-400 hover:bg-emerald-600 hover:text-amber-300 hover:drop-shadow-lg shadow rounded-r-lg align-bottom"
        >
      ...
      {:else}
        <h3
          class="p-10 font-bold text-amber-300 bg-emerald-400 hover:bg-emerald-600 hover:text-amber-300 hover:drop-shadow-lg shadow rounded-r-lg align-bottom"
        >
          {$_("loading")}
        </h3>
      {/if}
