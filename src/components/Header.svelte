...
>
	<div class="flex">
		<Button color="none" class="dark:text-white"
			>{$_("locale.short")}</Button
		>
		<Dropdown>
			<DropdownItem on:click={() => setLocale("en")}
				>🇬🇧</DropdownItem
			>
			<DropdownItem on:click={() => setLocale("es")}
				>🇪🇸</DropdownItem
			>
