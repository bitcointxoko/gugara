...
<Card img={event.tagValue('image')} class="bg-warm-50">
	<a
		href="{PUBLIC_NOSTR_LONG_FORM_CLIENT}a/{event.encode()}"
		class="text-2xl font-bold tracking-tight text-gray-900 hover:text-gray-600 dark:text-white dark:hover:text-gray-300"
	>
