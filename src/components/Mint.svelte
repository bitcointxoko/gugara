...
<Card class="flex flex-col justify-between bg-warm-50">
	<div class="align-center flex">
		<h5
			class="mb-2 mr-auto text-2xl font-bold text-gray-900 dark:text-white"
		>
			{$_("mint.title")}
		</h5>
	...
	{#if balance}
		<div class="flex items-center">
			<div
				class="mr-auto flex pr-2 align-bottom font-normal text-gray-700 dark:text-gray-400"
			>
			...
			<Button href={PUBLIC_NUTSTASH}>
				{$_("mint.nutstash")}
				<ArrowRightOutline
					class="ms-2 h-3.5 w-3.5 text-white"
				/>
			</Button>
		</div>
	{:else}
