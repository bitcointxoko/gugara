...
<div
  class="basis-1/3 p-2 sm:p-4 md:p-6 gap-4 rounded-lg border border-solid hover:border-amber-500 bg-white text-black font-mono max-w-lg"
>
      ...
      {#each Array.from(events) as event}
        <div class="text-gray-600 hover:text-amber-600">
          <a href="{PUBLIC_NOSTR_LONG_FORM_CLIENT}/a/{event.encode()}">
            ...
            <div
              class="mt-1 text-sm font-thin text-gray-500 border-b border-dotted"
            >
              {new Date(
            ...
            <p class="p-2 text-gray-600 border-gray-300">
